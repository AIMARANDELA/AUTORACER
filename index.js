...
app.post("/validate-payment", async (req, res) => {
    try {
        const {
            ...
            bankFrom, paymentPhone, amountPaid, reference, screenshotUrl
        } = req.body;

        console.log("Validando pago:", { name, phone, reference, screenshotUrl });
        ...
        const { data: participant, error: pErr } = await supabase
            .from("participants")
            .insert({ name, cedula: cedula || "", phone, email: email || "" })
            .select("id")
            .single();
        ...
        const { error: payErr } = await supabase
            ...
            .insert({
                ...
                bank_from: bankFrom || "",
                payment_phone: paymentPhone || phone,
